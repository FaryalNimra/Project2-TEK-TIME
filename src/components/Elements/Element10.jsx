      ...
      <div className="row3">
        <div className="col-md-6a">
          <div className="element10-content">
            ...
            <p className="element10-paragraph">With TekTime, you can easily manage your meetings with real-time updates,<br></br> scheduling, and detailed participant insights.</p>
          </div>
        </div>
        <div className="col-md-6a">
